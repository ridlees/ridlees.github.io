...
Zde jak to vypadá ![Jednoduchý editor dvou textů najednou](translator.png "Translator") Trochu doufám, že to otestuji na nějakých překladatelých (min pro mé překlady v ICT union se to bude hodit)
...
remade by them. The price of this power is mutual obligation: we can never let ourselves oﬀ
